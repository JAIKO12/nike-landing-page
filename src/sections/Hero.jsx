  ...
  return (
   <section id="home" className='w-full flex xl:flex-row flex-col justify-center min-h-screen gap-10  max-container  p-2'>
    ...
    <div className='relative xl:w-2/5 flex flex-col justify-center items-start w-full max-xl:padding-x pt-28'>
      <p className='text-xl font-montserrat  text-coral-red'>Our Summer Colletion</p>
     ...
     <span className='xl:bg-white xl:whitespace-nowrap relative z-10 pr-10'>The New Arrival</span>
      ...
      Experience the superior quality of Nike shoes, with selected materials and the latest technology that provides maximum comfort. Light stride, optimal performance, only with Nike.s</p>
      ...
      <div className='relative flex-1  flex justify-center items-center xl:min-h-screen max-xl:py-10 bg-primary bg-hero bg-cover bg-center'>
        <img className='object-contain relative z-10' src={bigShoeImg}  width={510} height={500} alt="" />
